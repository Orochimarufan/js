        ...
        Settings: (function(){
            ...
            Settings.prototype = Object.assign(Object.create(ndevent.EventTarget.prototype), {
                ...
                setItem: function setItem(setting, value) {
                    ...
                    if (ospec.set_proxy)
                        return ospec.set_proxy.call(this, setting, ospec, value, this._settings[setting], bind(curry(this.__Settings_raw_set, setting), this));
                    else
                        return this.__Settings_raw_set.call(this, setting, value);
                },
                ...
                resetItem: function resetItem(setting) {
                    ...
                    if (ospec.subkey) // XXX Bad
                        ...
                        ospec.set_proxy.call(this, setting, ospec, undefined, this._settings[setting], bind(curry(this.__Settings_raw_set, setting), this));
                    else
                        delete this._settings[setting];
                    this.__Settings_changed.call(this, setting, old, ospec.default);
                    return true;
                },
                ...
                settings.forEach(function (setting, ospec) {
                    ...
                    if (ospec.hasOwnProperty("ui")) {
                        ...
                        if (tmset.ui_classes.hasOwnProperty(ui_spec.type)) {
                            ...
                            console.log("Settings UI Class for " + setting + " unknown: " + ui_spec.type);
                    }
                });
